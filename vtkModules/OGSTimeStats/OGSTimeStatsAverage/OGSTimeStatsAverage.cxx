/*=========================================================================
  ...
  Module:    OGSTimeStatsAverage.cxx
...
vtkStandardNewMacro(OGSTimeStatsAverage);

#ifdef PARAVIEW_USE_MPI
#include "vtkMultiProcessController.h"
vtkCxxSetObjectMacro(OGSTimeStatsAverage, Controller,
...
//----------------------------------------------------------------------------
OGSTimeStatsAverage::OGSTimeStatsAverage() {
  this->sum_weights = 0.;
...
//----------------------------------------------------------------------------
int OGSTimeStatsAverage::RequestInformation(
...
//------------------------------------------------------------------------------
int OGSTimeStatsAverage::RequestUpdateExtent(
...
//----------------------------------------------------------------------------
int OGSTimeStatsAverage::RequestData(vtkInformation *request,
...
//----------------------------------------------------------------------------
int OGSTimeStatsAverage::PipelineIterationAlgorithm(vtkInformation *request,
                                                    vtkDataSet *inData,
                                                    vtkDataSet *outData) {
...
//----------------------------------------------------------------------------
int OGSTimeStatsAverage::FileIterationAlgorithm(vtkInformation *request,
                                                vtkDataSet *inData,
                                                vtkDataSet *outData) {
  // Check inputs
  ...
  */
  ...
  try {
    ogs_data->load_mesh(0);
  } catch (...) {
    vtkErrorMacro("Cannot load mesh data!\nAborting...");
    return 0;
  }
  ...
  */
  ...
  size_t ii_start = 0, ii_end = this->instants.size();
  ...
  // Loop the instants
  double w_sum = 0.;
  for (size_t inst = ii_start; inst < ii_end; ++inst) {
...
//----------------------------------------------------------------------------
void OGSTimeStatsAverage::SetStartTI(const char *tstep) {
...
void OGSTimeStatsAverage::SetEndTI(const char *tstep) {
...
//----------------------------------------------------------------------------
vtkStringArray *OGSTimeStatsAverage::GetTimeValues() {
