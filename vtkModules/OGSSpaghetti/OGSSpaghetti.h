...
class VTK_EXPORT OGSSpaghetti : public vtkTableAlgorithm {
 ...
 private:
  OGSSpaghetti(const OGSSpaghetti &) = delete;
  void operator=(const OGSSpaghetti &) = delete;
  ...
  int FileIterationAlgorithm(vtkInformation *, vtkDataSet *, vtkDataSet *,
                             vtkTable *);
  int AveragesIterationAlgorithm(int, vtkInformation *, vtkDataSet *,
                                 vtkDataSet *, vtkTable *);
