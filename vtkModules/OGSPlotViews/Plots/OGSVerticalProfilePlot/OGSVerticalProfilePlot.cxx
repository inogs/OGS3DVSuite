...
vtkStandardNewMacro(OGSVerticalProfilePlot);
...
//----------------------------------------------------------------------------
void OGSVerticalProfilePlot::Update() {
...
//----------------------------------------------------------------------------
void OGSVerticalProfilePlot::SetParameterInternal(const char* raw_name,
...
void OGSVerticalProfilePlot::SetParameter(const char* raw_name,
                                          const char* value) {
  std::ostringstream buf;
...
void OGSVerticalProfilePlot::SetParameter(const char* raw_name, int value) {
  std::ostringstream buf;
  buf << value;
  this->SetParameterInternal(raw_name, buf.str().c_str());
}

void OGSVerticalProfilePlot::SetParameter(const char* raw_name, double value) {
  std::ostringstream buf;
  buf << value;
  this->SetParameterInternal(raw_name, buf.str().c_str());
}

void OGSVerticalProfilePlot::SetParameter(const char* raw_name, double value1,
