...
#include "OGSVerticalProfilePythonView.h"
...
OGSVerticalProfilePlot::OGSVerticalProfilePlot(const QString& group,
                                               ...
                                               pqServer* server,
                                               QObject* parent)
    : pqPythonView(OGSVerticalProfilePlot::OGSVerticalProfilePlotType(), group,
                   name,
                   vtkSMOGSVerticalProfilePlotProxy::SafeDownCast(renModule),
                   server, parent)
